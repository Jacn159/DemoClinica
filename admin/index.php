                        ...
                        <tr>
                            <td>
                                <p
                                    ...
                                    Próximas citas hasta el próximo
                                    <?php
                                    $dias = array('Domingo', 'Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado');
                                    echo $dias[date('w', strtotime("+1 week"))];
                                    ?>
                                </p>
                                ...
                                <p
                                    ...
                                    Más detalles disponibles en @Appointment sección.
                                </p>
                            ...
                            <td>
                                <p
                                    ...
                                    Próximas Atenciones hasta el próximo
                                    <?php
                                    $dias = array('Domingo', 'Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado');
                                    echo $dias[date('w', strtotime("+1 week"))];
                                    ?>
                                ...
                                <p
                                    ...
                                    Aquí tienes un acceso rápido a las próximas Atenciones programadas hasta dentro de 7
                                    días<br>
                                    Añade, elimina y muchas más funciones disponibles en la sección @Schedule.
                                </p>
                                        ...
                                        <table width="85%" class="sub-table scrolldown" border="0">
                                            ...
                                            <tbody>
                                                ...
                                                if ($result->num_rows == 0) {
                                                    ...
                                                    No pudimos encontrar nada relacionado con sus palabras clave!</p>
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar todas las Atenciones &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
                            ...
                            <td>
                                <center>
                                    <a href="appointment.php" class="non-style-link"><button class="btn-primary btn"
                                            style="width:85%">Mostrar todas las citas</button></a>
                                </center>
                            </td>
                            <td>
                                <center>
                                    <a href="schedule.php" class="non-style-link"><button class="btn-primary btn"
                                            style="width:85%">Mostrar todas las Atenciones</button></a>
                                </center>
                            </td>
                        </tr>
                    </table>
