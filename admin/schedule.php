                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <select name="docid" id="" class="box filter-container-items"
                                        ...
                                        <option value="" disabled selected hidden>Elija el nombre de la doctora de la
                                            lista
                                        </option><br />
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Añadir Nueva Atención.</p><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                <form action="add-session.php" method="POST" class="add-new-form">
                                    ...
                                    Título de la Atención : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="title" class="input-text" placeholder="
                                    Nombre de esta Atención" required><br>
                                </td>
                            </tr>
                            <tr>
            ...
            echo '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="nop" class="input-text" min="0"  placeholder="El número de cita final para esta Atención depende de este número." required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Colocar esta Atención" class="login-btn btn-primary btn" name="shedulesubmit">
                                </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Doctor de esta Atención: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label">Hora programada
                                    : </label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>
                                    Pacientes que ya se registraron para esta Atención:</b> (' . $result12->num_rows . "/" . $nop . ')</label>
                                    <br><br>
                                </td>
                            </tr>
