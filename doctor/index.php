                        ...
                        <table class="filter-container doctor-header" style="border: none;width:95%" border="0">
                            <tr>
                                <td>
                                    ...
                                    <p>Gracias por unirte a nosotros. Siempre estamos tratando de brindarle un servicio
                                        completo<br>
                                        Puede ver su horario diario y llegar a la cita de los pacientes en
                                        casa!<br><br>
                                    </p>
                                    <a href="appointment.php" class="non-style-link"><button class="btn-primary btn"
                                            style="width:30%">Ver Mis Citas</button></a>
                                    <br>
                                    <br>
                                </td>
                            </tr>
